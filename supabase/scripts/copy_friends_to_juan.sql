-- Idempotent clone: Cesar Pulido + RT DobleU rides → Juan Valdes.
-- Cesar:  124a264f-cbb4-4acb-8b81-6ae15fd4f33a
-- DobleU: 5683b7e0-1382-4d1f-8cbc-3fe810d312d4
-- Juan:   7b6b3eb1-4887-42de-b204-4b67f7c41d02
...
where user_id = '7b6b3eb1-4887-42de-b204-4b67f7c41d02'
  and (local_id like 'copy-from-cesar-%' or local_id like 'copy-from-dobleu-%');

delete from public.routes
where owner_id = '7b6b3eb1-4887-42de-b204-4b67f7c41d02'
