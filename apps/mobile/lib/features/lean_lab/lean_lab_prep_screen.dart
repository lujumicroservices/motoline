...
/// Pre-ride ritual: direction + upright g0 freeze (center mount) → start recording.
...
class _LeanLabPrepScreenState extends ConsumerState<LeanLabPrepScreen> {
  ...
  Future<void> _startRide() async {
    ...
    recorder.prepareLeanLabUpright(g0);
    recorder.prepareLeanLabNeutral(0);
    recorder.setLeanMountMode('mount');
    _sensor.stop();
    try {
      if (!mounted) return;
        ...
        MaterialPageRoute<void>(
          builder: (_) => ActiveRideScreen(
            ...
            leanLabBootstrap: LeanLabRideBootstrap(
              ...
              phonePose: PhonePoseId.portraitScreenOut,
              frozenNeutralDeg: 0,
              frozenG0: g0,
              calibAt: _calibAt,
            ),
